...
var misterspexApp = angular.module('misterspexApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'misterspexAppUtils', 'pascalprecht.translate', 'truncate', 'ngCacheBuster']);
